...
namespace pages {
    ...
    // Page responsible for interactively returning a car
    class ReturnVehiclePage : public Page {
        ...
        private:
            ...
            // User entered values collected to return the car
            struct Fields {
                QString
                    vehicleId = ""
                ;
            ...
            using Handler = void (ReturnVehiclePage::*)(const QString& input, App& app);
            ...
            static inline const Handler handlers[static_cast<int>(Mode::count)] = {
                &ReturnVehiclePage::handleMenuInput,
                &ReturnVehiclePage::handleEnterVehicleIdInput
            };
