...
namespace pages {
    ...
    // Page responsible for displaying all available vehicles only
    class DisplayAvailableVehiclesOnlyPage : public Page {
        ...
        private:
            ...
            using Handler = void (DisplayAvailableVehiclesOnlyPage::*)(const QString& input, App& app);
            ...
            static inline const Handler handlers[static_cast<int>(Mode::count)] = {
                &DisplayAvailableVehiclesOnlyPage::handleMenuInput
            };
