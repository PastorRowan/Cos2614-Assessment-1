...
namespace pages {
    ...
    // Page responsible for interactively renting a car
    class RentVehiclePage : public Page {
        ...
        private:
            ...
            // User entered values collected to rent the car
            struct Fields {
                QString
                    vehicleId = ""
                ;
            ...
            using Handler = void (RentVehiclePage::*)(const QString& input, App& app);
            ...
            static inline const Handler handlers[static_cast<int>(Mode::count)] = {
                &RentVehiclePage::handleMenuInput,
                &RentVehiclePage::handleEnterVehicleIdInput,
            };
