...
namespace pages {
    ...
    // Page responsible for interactively adding a motorcycle
    class AddMotorCyclePage : public Page {
        ...
        private:
            ...
            // User entered values collected while building the motorcycle object
            struct Fields {
                QString
                    brand = "",
                    model = "",
            ...
            void handleEnterEngineCapacityCC(const QString& input, App& app);

            using Handler = void (AddMotorCyclePage::*)(const QString& input, App& app);
            ...
            static inline const Handler handlers[static_cast<int>(Mode::count)] = {
                &AddMotorCyclePage::handleMenuInput,
                &AddMotorCyclePage::handleEnterBrandInput,
                &AddMotorCyclePage::handleEnterModelInput,
                &AddMotorCyclePage::handleEnterPricePerDayInput,
                &AddMotorCyclePage::handleEnterEngineCapacityCC
            };
